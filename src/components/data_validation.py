...
class DataValidation:
    ...
    def is_column_exist(self, df: DataFrame) -> bool:
        ...
        try:
            ...
            # agar ek bhi missing numerical columns aaya to logging raise kar denge
            ...
            # agar ek bhi missing categorical columns aagya to logging raise kar denge

            return False if len(missing_categorical_columns)>0 or len(missing_numerical_columns)>0 else True
        except Exception as e:
            raise MyException(e, sys) from e

    # Below function is reading the train and test data path 
    @staticmethod
